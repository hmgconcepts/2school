...
// ---- 4. SQL + CSV bundling ----
[
  // v7 has one authoritative fresh-install schema; the old files remain only
  // as source-history upgrade artifacts and are intentionally not bundled.
  'database/complete-schema.sql', 'database/README.md',
